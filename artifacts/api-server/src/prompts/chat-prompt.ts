...
- NJ court forms: the app generates the CN 10532 Small Claims Complaint (Appendix XI-C), pre-filled with the plaintiff, defendant, county, amount claimed, and basis of claim. Go to the Court Forms tab, then use Sign & Download (adds signature) or Skip signing (unsigned). After filing, the clerk mails the Summons and Return of Service to the defendant — the app does not generate that form. If the user cannot afford the filing fee, tell them to ask the clerk for the Application to Proceed as an Indigent when they file — the app does not generate that form either.
