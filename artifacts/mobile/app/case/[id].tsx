...
const FL_CHECKLIST = [
  ...
  { id: "2", label: "Upload all evidence documents", done: false },
  { id: "3", label: "Send demand letter to defendant", done: false },
  { id: "4", label: "Download and review Statement of Claim", done: false },
  { id: "5", label: "File Statement of Claim at county court clerk", done: false },
  { id: "6", label: "Pay filing fee at clerk's window (see fee schedule)", done: false },
  { id: "7", label: "Court issues summons — served by sheriff or process server", done: false },
  { id: "8", label: "Prepare opening statement (2-3 min)", done: false },
  { id: "9", label: "Organize evidence copies (3 sets)", done: false },
  { id: "10", label: "Arrive 30 minutes early on hearing day", done: false },
];
...
const AZ_CHECKLIST = [
  ...
  { id: "2", label: "Upload all evidence documents", done: false },
  { id: "3", label: "Send demand letter to defendant", done: false },
  { id: "4", label: "Download AZ Complaint (LJSC00001F) and Summons (LJSC00002F) — review before filing", done: false },
  { id: "5", label: "File complaint at justice court clerk's office (bring both forms for clerk to stamp the summons)", done: false },
  { id: "6", label: "Pay $25 filing fee at clerk's window — if you cannot afford it, ask the clerk for the fee waiver form (AOCDFGF1F)", done: false },
  { id: "7", label: "Arrange service on defendant yourself using the stamped summons (certified mail, constable, or process server — court does NOT serve for you)", done: false },
  { id: "8", label: "Confirm defendant served before hearing deadline — check your hearing notice for the required deadline", done: false },
  { id: "9", label: "Download and file Proof of Service (LJSC00003F) with the court within 45 days of filing your complaint", done: false },
            ...
            <>
              <View style={styles.deadlineRow}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={[styles.deadlineItemDate, { color: colors.teal }]}>By {fmt(addDays(hearingDate, -10))}</Text>
                </View>
              </View>
              <View style={[styles.deadlineLine, { backgroundColor: colors.border }]} />
              <View style={styles.deadlineRow}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={[styles.deadlineItemLabel, { color: colors.foreground }]}>Serve defendant — out of county</Text>
