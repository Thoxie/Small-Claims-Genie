...
- Auto Negligence intake (Form 7.330): Step 2 of intake collects four dedicated fields — Date of Collision (same as the general incident date), Collision Location (intersection or street address), Public Highway name (optional, leave blank if not a named highway), and County Where Collision Occurred (may differ from the filing county). These pre-fill Form 7.330 directly — the collision county field is NEVER defaulted to the court county.
