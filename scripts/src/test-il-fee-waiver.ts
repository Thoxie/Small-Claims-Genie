/**
 * End-to-end test: IL Application for Waiver of Court Fees form download
 *
 * Run with:
...
async function main() {
  ...
  const url = `${BASE_URL}/api/cases/${caseId}/forms/il/fee-waiver`;
  ...
  if (passed) {
    console.log("\n✅ All assertions passed — IL Application for Waiver of Court Fees PDF is correct.");
  } else {
    console.error("\n❌ Test failed.");
    process.exit(1);
  }
