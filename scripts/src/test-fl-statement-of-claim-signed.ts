 ...
 *
 * Note: This form uses buildFLStatementOfClaim whose signature y-position is computed
 * dynamically from content layout. No pixel-level placement check is performed here;
 * the HTTP + text-layer assertions catch all rendering regressions.
 */
