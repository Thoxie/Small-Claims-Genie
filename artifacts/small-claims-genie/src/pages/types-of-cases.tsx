      ...
      <section className="px-6 pt-10 pb-4 bg-[#f5fdfb]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl mb-4">
            Small Claims Genie helps you navigate small claims court by identifying the right jurisdiction and venue,
            organizing your evidence using our AI Genie to create a powerful case. The AI Genie prepares court-ready
            documents to file in minutes, creates a polished statement to read to the judge, performs mock hearings
            with AI so you can practice, handles all the guiding service steps, and gets you ready for court.{" "}
            <span className="font-semibold text-primary">Get your money back.</span>
          </p>
