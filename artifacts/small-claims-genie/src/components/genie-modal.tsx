  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (data.code === "RATE_LIMITED") { setIsRateLimited(true); }
        ...
        <div className="flex items-center gap-3 px-5 py-4 shrink-0 rounded-t-[24px]"
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/70 text-[11px] leading-tight">
              Describe your dispute or ask about how it works
            </p>
          </div>
            ...
            <div className="flex gap-2.5">
              ...
              <div className="bg-[#f0fffe] border border-[#a8e6df] rounded-2xl rounded-tl-sm px-3.5 py-2.5 max-w-[88%]">
                <p className="text-sm text-[#0d4a44] leading-relaxed">
                  Hi! Tell me what happened in plain English — what went wrong, who did it, and roughly how much you're out. Or ask me anything about how Small Claims Genie works and what it costs. I'm here to help.
                </p>
              </div>
            </div>
          )}
        ...
        <div className="border-t px-4 py-3 flex gap-2 items-center shrink-0 bg-white rounded-b-[24px]">
          <div className="flex-1 relative flex items-center">
            <textarea
              ...
              onKeyDown={handleKey}
              placeholder={isRecording ? "🔴 Recording — tap mic to stop…" : hasMessages ? "Ask a follow-up question…" : "My landlord kept my $1,800 deposit but never gave me a receipt…"}
              rows={1}
