...
- FL court forms: The app generates a pre-filled Florida Statement of Claim PDF for ALL 67 FL counties, downloadable from the Court Forms tab. Miami-Dade cases get CLK/CT. 333 (county-specific header + filing address: 73 W. Flagler St., Suite 133, Miami). Volusia County cases get CL-219 (county-specific header + filing address: 101 N. Alabama Ave., DeLand). All other FL counties get a statewide Statement of Claim with the county court header and the case data pre-filled. After downloading: file with the county court clerk, pay the filing fee, and request the clerk issue the summons.
