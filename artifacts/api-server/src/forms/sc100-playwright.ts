...
const FB: Record<string, Record<string, FieldCoord>> = {
  ...
  "2": {
    ...
    plaintiffName:        { x: 92,  y: 110, size: 11 },
    plaintiffPhone:       { x: 487, y: 110, size: 11 },
    ...
    p2Name:               { x: 92,  y: 218, size: 11 },
    p2Phone:              { x: 487, y: 218, size: 11 },
    ...
    defendantName:        { x: 92,  y: 395, size: 11 },
    defendantPhone:       { x: 487, y: 395, size: 11 },
...
function buildHtml(d: SC100Data, assetDir: string, sigDataUrl?: string): string {
  ...
  // height of 30pt, top:y=259 puts the signature bottom at y=289 — sitting
