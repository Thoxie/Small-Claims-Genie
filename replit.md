...
- **Page 1**: Cover/instructions page — courthouse name/address/city (x=362), county (x=475), case name (x=362, y=442) overlaid in right-column boxes. x=337 is too far left (lands in left instructions column); x=362 is safely inside the court info box.
