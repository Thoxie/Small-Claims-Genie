...
export const casesTable = pgTable("cases", {
  ...
  plaintiffIsFictitious: boolean("plaintiff_is_fictitious").default(false),
  plaintiffDbaName: text("plaintiff_dba_name"),
  plaintiffDbaAddress: text("plaintiff_dba_address"),
  plaintiffDbaCity: text("plaintiff_dba_city"),
  plaintiffDbaState: text("plaintiff_dba_state"),
  plaintiffDbaZip: text("plaintiff_dba_zip"),
  plaintiffDbaMailingAddress: text("plaintiff_dba_mailing_address"),
  plaintiffBusinessType: text("plaintiff_business_type"),
  plaintiffBusinessTypeOther: text("plaintiff_business_type_other"),
  plaintiffFbnNumber: text("plaintiff_fbn_number"),
  plaintiffFbnExpiry: text("plaintiff_fbn_expiry"),
  plaintiffFbnSignDate: text("plaintiff_fbn_sign_date"),
  plaintiffFbnCounty: text("plaintiff_fbn_county"),
  ...
  secondPlaintiffDbaName: text("second_plaintiff_dba_name"),
  secondPlaintiffDbaAddress: text("second_plaintiff_dba_address"),
  secondPlaintiffDbaCity: text("second_plaintiff_dba_city"),
  secondPlaintiffDbaState: text("second_plaintiff_dba_state"),
  secondPlaintiffDbaZip: text("second_plaintiff_dba_zip"),
  secondPlaintiffDbaMailingAddress: text("second_plaintiff_dba_mailing_address"),
  secondPlaintiffBusinessType: text("second_plaintiff_business_type"),
  secondPlaintiffBusinessTypeOther: text("second_plaintiff_business_type_other"),
  secondPlaintiffFbnNumber: text("second_plaintiff_fbn_number"),
  secondPlaintiffFbnExpiry: text("second_plaintiff_fbn_expiry"),
  secondPlaintiffFbnSignDate: text("second_plaintiff_fbn_sign_date"),
  secondPlaintiffFbnCounty: text("second_plaintiff_fbn_county"),
  secondPlaintiffTitle: text("second_plaintiff_title"),
  ...
  demandLetterTextFormal: text("demand_letter_text_formal"),
  demandLetterTextFirm: text("demand_letter_text_firm"),
  demandLetterTextFriendly: text("demand_letter_text_friendly"),
  ...
  // ── MC-030 Declaration title, body text, and exhibit selections ──────────────
  mc030DeclarationTitle: text("mc030_declaration_title"),
  mc030DeclarationText: text("mc030_declaration_text"),
