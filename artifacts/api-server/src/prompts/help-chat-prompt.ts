...
- NJ court forms: Small Claims Genie does NOT yet generate pre-filled NJ forms — download the Small Claims Complaint, Appendix XI-A(2) Summons and Return of Service, and optional Fee Waiver directly from the NJ Courts Small Claims Self-Help center
...
- WA court forms: Small Claims Genie does NOT yet generate pre-filled WA forms — download the Notice of Small Claim and Small Claims Calendar Notice directly from Washington Courts Small Claims Resources
...
- Statute of limitations: written and oral contracts ${NJ.statuteOfLimitations[0].period}, property damage ${NJ.statuteOfLimitations[2].period}, personal injury ${NJ.statuteOfLimitations[3].period} (${NJ.statuteOfLimitationsCitation})
- Service: ${NJ.serviceDeadlineText}. ${NJ.serviceMethodsText} (${NJ.serviceOfProcessCitation})
- NJ court forms: Small Claims Complaint, Appendix XI-A(2) Summons and Return of Service, optional Fee Waiver. NOTE: the app does not yet generate pre-filled NJ forms — download blank forms from the NJ Courts Small Claims Self-Help center, fill them out, and file with the clerk
- After winning: judgment valid ${NJ.judgmentValidityYears} years, renewable for another ${NJ.judgmentValidityYears}. Collection options: ${NJ.collectionToolsText}
- Appeal: ${NJ.appealNote}
...
- Statute of limitations: written contracts ${WA.statuteOfLimitations[0].period}, oral contracts ${WA.statuteOfLimitations[1].period}, property damage ${WA.statuteOfLimitations[2].period}, personal injury ${WA.statuteOfLimitations[3].period} (${WA.statuteOfLimitationsCitation})
- Service: ${WA.serviceDeadlineText}. ${WA.serviceMethodsText} (${WA.serviceOfProcessCitation})
- WA court forms: Notice of Small Claim, Small Claims Calendar Notice. NOTE: the app does not yet generate pre-filled WA forms — download blank forms from Washington Courts Small Claims Resources, fill them out, and file with the clerk
- After winning: judgment valid ${WA.judgmentValidityYears} years, renewable for another ${WA.judgmentValidityYears}. Collection options: ${WA.collectionToolsText}
- Appeal: ${WA.appealNote} — never state a specific appeal deadline number, it is unverified
- Key counties: ${WA.keyCounties?.join(", ")}
