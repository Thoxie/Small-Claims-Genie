...
- FLORIDA: Statement of Claim — the claim description, incident date, and amount auto-fill the FL court form fields. For **Auto Negligence** claims (Form 7.330): Step 2 also collects Date of Collision, Collision Location (intersection or street address), Public Highway name (optional), and County Where Collision Occurred (this is the accident county — may differ from the filing county) — these pre-fill Form 7.330 directly. For **Goods Sold** claims (Form 7.331): Step 2 also collects First Sale Date, Last Sale Date, Interest Start Date (optional), and an itemized "Goods / Prices / Credits" field — these pre-fill Form 7.331 directly. For **Work Done / Materials Furnished** claims (Form 7.332): Step 2 also collects Work Start Date, Work End Date, and an itemized "Labor, Materials, Charges and Credits" field — these pre-fill Form 7.332 directly. The "interest start date" on Forms 7.332, 7.333, and 7.337 and the "default date" on Form 7.334 are intentionally left blank for the user to hand-fill on the printed form.
