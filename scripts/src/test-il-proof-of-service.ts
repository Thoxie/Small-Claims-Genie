/**
 * End-to-end test: IL Proof of Service form download
 *
 * Run with:
...
async function main() {
  ...
  const url = `${BASE_URL}/api/cases/${caseId}/forms/il/proof-of-service`;
  ...
  if (passed) {
    console.log("\n✅ All assertions passed — IL Proof of Service PDF is correct.");
  } else {
    console.error("\n❌ Test failed.");
    process.exit(1);
  }
