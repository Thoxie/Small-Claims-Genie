...
export async function fetchBeta(): Promise<BetaData> {
  return apiFetch<BetaData>("/admin/beta");
}

export async function fetchGenieConversions(): Promise<GenieConversionRow[]> {
...
export interface GenieConversionRow {
  id: number;
  question: string;
