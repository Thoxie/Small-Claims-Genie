...
export function IntakeStep1({ initialData, onNext, saving, onSaveExit, onAiCheck }: Props) {
  ...
  const [plaintiffDbaMailingDiffers, setPlaintiffDbaMailingDiffers] = useState(
    !!(initialData.plaintiffDbaMailingAddress)
  );
  ...
  const [secondPlaintiffDbaMailingDiffers, setSecondPlaintiffDbaMailingDiffers] = useState(
    !!(initialData.secondPlaintiffDbaMailingAddress)
  );
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      plaintiffIsFictitious: initialData.plaintiffIsFictitious || false,
      plaintiffDbaName: initialData.plaintiffDbaName || "",
      plaintiffDbaAddress: initialData.plaintiffDbaAddress || "",
      plaintiffDbaCity: initialData.plaintiffDbaCity || "",
      plaintiffDbaState: initialData.plaintiffDbaState || (initialData.jurisdictionState ?? "CA"),
      plaintiffDbaZip: initialData.plaintiffDbaZip || "",
      plaintiffDbaMailingAddress: initialData.plaintiffDbaMailingAddress || "",
      plaintiffBusinessType: initialData.plaintiffBusinessType || "",
      plaintiffBusinessTypeOther: initialData.plaintiffBusinessTypeOther || "",
      plaintiffFbnNumber: initialData.plaintiffFbnNumber || "",
      plaintiffFbnExpiry: initialData.plaintiffFbnExpiry || "",
      plaintiffFbnSignDate: initialData.plaintiffFbnSignDate || "",
      plaintiffFbnCounty: initialData.plaintiffFbnCounty || "",
      ...
      plaintiffState: initialData.plaintiffState || (initialData.jurisdictionState ?? "CA"),
      ...
      plaintiffMailingState: initialData.plaintiffMailingState || (initialData.jurisdictionState ?? "CA"),
      ...
      secondPlaintiffState: initialData.secondPlaintiffState || (initialData.jurisdictionState ?? "CA"),
      ...
      secondPlaintiffMailingState: initialData.secondPlaintiffMailingState || (initialData.jurisdictionState ?? "CA"),
      ...
      secondPlaintiffDbaName: initialData.secondPlaintiffDbaName || "",
      secondPlaintiffDbaAddress: initialData.secondPlaintiffDbaAddress || "",
      secondPlaintiffDbaCity: initialData.secondPlaintiffDbaCity || "",
      secondPlaintiffDbaState: initialData.secondPlaintiffDbaState || (initialData.jurisdictionState ?? "CA"),
      secondPlaintiffDbaZip: initialData.secondPlaintiffDbaZip || "",
      secondPlaintiffDbaMailingAddress: initialData.secondPlaintiffDbaMailingAddress || "",
      secondPlaintiffBusinessType: initialData.secondPlaintiffBusinessType || "",
      secondPlaintiffBusinessTypeOther: initialData.secondPlaintiffBusinessTypeOther || "",
      secondPlaintiffFbnNumber: initialData.secondPlaintiffFbnNumber || "",
      secondPlaintiffFbnExpiry: initialData.secondPlaintiffFbnExpiry || "",
      secondPlaintiffFbnSignDate: initialData.secondPlaintiffFbnSignDate || "",
      secondPlaintiffFbnCounty: initialData.secondPlaintiffFbnCounty || "",
      secondPlaintiffTitle: initialData.secondPlaintiffTitle || "",
      ...
      defendantAgentState: initialData.defendantAgentState || (initialData.jurisdictionState ?? "CA"),
      ...
      defendantState: initialData.defendantState || (initialData.jurisdictionState ?? "CA"),
      ...
      defendantMailingState: initialData.defendantMailingState || (initialData.jurisdictionState ?? "CA"),
  ...
  const plaintiffIsFictitious = form.watch("plaintiffIsFictitious");
  const plaintiffBusinessType = form.watch("plaintiffBusinessType");
  const hasAdditionalPlaintiff = form.watch("hasAdditionalPlaintiff");
  const additionalPlaintiffIsFictitious = form.watch("additionalPlaintiffIsFictitious");
  const secondPlaintiffBusinessType = form.watch("secondPlaintiffBusinessType");
  ...
  const handleSubmit = (data: Record<string, unknown>) => {
    ...
    if (!data.plaintiffIsFictitious) {
      data.plaintiffDbaName = "";
      data.plaintiffDbaAddress = "";
      data.plaintiffDbaCity = "";
      data.plaintiffDbaState = "";
      data.plaintiffDbaZip = "";
      data.plaintiffDbaMailingAddress = "";
      data.plaintiffBusinessType = "";
      data.plaintiffBusinessTypeOther = "";
      data.plaintiffFbnNumber = "";
      data.plaintiffFbnExpiry = "";
      data.plaintiffFbnSignDate = "";
    } else if (!plaintiffDbaMailingDiffers) {
      data.plaintiffDbaMailingAddress = "";
    }
    if (data.plaintiffBusinessType !== "other") {
      data.plaintiffBusinessTypeOther = "";
    }
    if (!data.additionalPlaintiffIsFictitious) {
      data.secondPlaintiffDbaName = "";
      data.secondPlaintiffDbaAddress = "";
      data.secondPlaintiffDbaCity = "";
      data.secondPlaintiffDbaState = "";
      data.secondPlaintiffDbaZip = "";
      data.secondPlaintiffDbaMailingAddress = "";
      data.secondPlaintiffBusinessType = "";
      data.secondPlaintiffBusinessTypeOther = "";
      data.secondPlaintiffFbnNumber = "";
      data.secondPlaintiffFbnExpiry = "";
      data.secondPlaintiffFbnSignDate = "";
      data.secondPlaintiffTitle = "";
    } else if (!secondPlaintiffDbaMailingDiffers) {
      data.secondPlaintiffDbaMailingAddress = "";
    }
  ...
  return (
    <div className="px-4 pt-3 pb-4 space-y-4">
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start">
            ...
            <div className="rounded-xl border p-5 space-y-4">
              ...
              {/* DBA / Fictitious Business Name toggle */}
              <FormField control={form.control} name="plaintiffIsFictitious" render={({ field }) => (
                <div className="flex items-center space-x-2 pt-1">
                  <Checkbox
                    id="plaintiff-dba-toggle"
                    checked={!!field.value}
          ...
          {plaintiffIsFictitious && (
            <div className="rounded-xl border border-dashed border-amber-300/60 p-5 space-y-3 bg-amber-50/30">
                  ...
                  <FormField control={form.control} name="plaintiffDbaName" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Business Name (DBA) <span className="text-destructive">*</span></FormLabel>
                  ...
                  <FormField control={form.control} name="plaintiffDbaAddress" render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-[11px] text-muted-foreground -mt-1">No P.O. Box</p>
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    <FormField control={form.control} name="plaintiffDbaCity" render={({ field }) => (
                      <FormItem className="col-span-2"><FormLabel>City</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                    <FormField control={form.control} name="plaintiffDbaState" render={({ field }) => (
                      <FormItem className="col-span-1"><FormLabel>State</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
                    <FormField control={form.control} name="plaintiffDbaZip" render={({ field }) => (
                      <FormItem className="col-span-2"><FormLabel>ZIP</FormLabel><FormControl><Input {...field} maxLength={5} onChange={(e) => field.onChange(formatZip(e.target.value))} /></FormControl><FormMessage /></FormItem>
                    )} />
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="dba-mailing-toggle"
                      checked={plaintiffDbaMailingDiffers}
                      onCheckedChange={(v) => setPlaintiffDbaMailingDiffers(!!v)}
                    />
                    <label htmlFor="dba-mailing-toggle" className="text-sm text-muted-foreground cursor-pointer select-none">
                      Mailing address is different
                    </label>
                  </div>
                  {plaintiffDbaMailingDiffers && (
                    <FormField control={form.control} name="plaintiffDbaMailingAddress" render={({ field }) => (
                      <FormItem>
                        <FormLabel>Mailing Address</FormLabel>
                        <FormControl><Input {...field} placeholder="Full mailing address including city, state, ZIP" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  )}

                  <FormField control={form.control} name="plaintiffBusinessType" render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value || ""}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="association">An association</SelectItem>
                          <SelectItem value="llc">A limited liability company</SelectItem>
                          <SelectItem value="partnership">A partnership</SelectItem>
                  ...
                  {plaintiffBusinessType === "other" && (
                    <FormField control={form.control} name="plaintiffBusinessTypeOther" render={({ field }) => (
                      <FormItem>
                  ...
                  <FormField control={form.control} name="plaintiffFbnCounty" render={({ field }) => (
                    <FormItem>
                      <FormLabel>County Where Statement Was Filed</FormLabel>
                      <FormControl><Input {...field} placeholder="e.g. Los Angeles" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />

                  <FormField control={form.control} name="plaintiffFbnNumber" render={({ field }) => (
                    <FormItem>
                      <FormLabel>FBN Statement Number <span className="text-destructive">*</span></FormLabel>
                      <FormControl><Input {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <FormField control={form.control} name="plaintiffFbnExpiry" render={({ field }) => (
                      <FormItem>
                        <FormLabel>Expiration Date <span className="text-destructive">*</span></FormLabel>
                        <FormControl><DatePicker value={field.value ?? ""} onChange={field.onChange} placeholder="Select date" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="plaintiffFbnSignDate" render={({ field }) => (
                      <FormItem>
                        <FormLabel>Date Signed</FormLabel>
                        <FormControl><DatePicker value={field.value ?? ""} onChange={field.onChange} placeholder="Select date" disableFuture /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  </div>
          ...
          {hasAdditionalPlaintiff && (
            <div className="rounded-xl border border-dashed border-[#14b8a6]/40 p-5 space-y-3 bg-[#f0fffe]/50">
                  ...
                  {/* Fictitious business name toggle + DBA fields */}
                  <FormField control={form.control} name="additionalPlaintiffIsFictitious" render={({ field }) => (
                    <div className="flex items-center space-x-2 pt-1">
                      <Checkbox
                        id="second-plaintiff-dba-toggle"
                        checked={!!field.value}
                        onCheckedChange={(v) => {
                          field.onChange(!!v);
                          if (!v) setSecondPlaintiffDbaMailingDiffers(false);
                        }}
                      />
                  ...
                  {additionalPlaintiffIsFictitious && (
                    <div className="rounded-lg border border-dashed border-amber-300/60 p-4 space-y-3 bg-amber-50/30">
                      ...
                      <FormField control={form.control} name="secondPlaintiffDbaAddress" render={({ field }) => (
                        <FormItem>
                          <FormLabel>Business Address <span className="text-destructive">*</span></FormLabel>
                          <p className="text-[11px] text-muted-foreground -mt-1">No P.O. Box</p>
                          <FormControl><Input {...field} placeholder="Street address" /></FormControl>
                      ...
                      <div className="grid grid-cols-5 gap-2">
                        <FormField control={form.control} name="secondPlaintiffDbaCity" render={({ field }) => (
                          <FormItem className="col-span-2"><FormLabel>City</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                        )} />
                        <FormField control={form.control} name="secondPlaintiffDbaState" render={({ field }) => (
                          <FormItem className="col-span-1"><FormLabel>State</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
                        )} />
                        <FormField control={form.control} name="secondPlaintiffDbaZip" render={({ field }) => (
                          <FormItem className="col-span-2"><FormLabel>ZIP</FormLabel><FormControl><Input {...field} maxLength={5} onChange={(e) => field.onChange(formatZip(e.target.value))} /></FormControl><FormMessage /></FormItem>
                        )} />
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="second-dba-mailing-toggle"
                          checked={secondPlaintiffDbaMailingDiffers}
                          onCheckedChange={(v) => setSecondPlaintiffDbaMailingDiffers(!!v)}
                        />
                        <label htmlFor="second-dba-mailing-toggle" className="text-sm text-muted-foreground cursor-pointer select-none">
                          Mailing address is different
                        </label>
                      </div>
                      {secondPlaintiffDbaMailingDiffers && (
                        <FormField control={form.control} name="secondPlaintiffDbaMailingAddress" render={({ field }) => (
                          <FormItem>
                            <FormLabel>Mailing Address</FormLabel>
                            <FormControl><Input {...field} placeholder="Full mailing address including city, state, ZIP" /></FormControl>
                            <FormMessage />
                      ...
                      <FormField control={form.control} name="secondPlaintiffBusinessType" render={({ field }) => (
                        <FormItem>
                          <FormLabel>Business Type <span className="text-destructive">*</span></FormLabel>
                          <Select onValueChange={field.onChange} value={field.value || ""}>
                            <FormControl>
                      ...
                      {secondPlaintiffBusinessType === "other" && (
                        <FormField control={form.control} name="secondPlaintiffBusinessTypeOther" render={({ field }) => (
                          <FormItem>
                            <FormLabel>If Other, specify</FormLabel>
                            <FormControl><Input {...field} /></FormControl>
                            <FormMessage />
                      ...
                      <FormField control={form.control} name="secondPlaintiffFbnNumber" render={({ field }) => (
                        <FormItem>
                          <FormLabel>FBN Statement Number <span className="text-destructive">*</span></FormLabel>
                          <FormControl><Input {...field} /></FormControl>
                          <FormMessage />
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <FormField control={form.control} name="secondPlaintiffFbnExpiry" render={({ field }) => (
                          <FormItem>
                            <FormLabel>Expiration Date <span className="text-destructive">*</span></FormLabel>
                            <FormControl><DatePicker value={field.value ?? ""} onChange={field.onChange} placeholder="Select date" /></FormControl>
                            <FormMessage />
                        ...
                        <FormField control={form.control} name="secondPlaintiffFbnSignDate" render={({ field }) => (
                          <FormItem>
                            <FormLabel>Date Signed</FormLabel>
                            <FormControl><DatePicker value={field.value ?? ""} onChange={field.onChange} placeholder="Select date" disableFuture /></FormControl>
                            <FormMessage />
                      ...
                      <FormField control={form.control} name="secondPlaintiffTitle" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input {...field} placeholder="e.g. Owner, CEO, Manager" /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )} />
                    </div>
      ...
      <div className="sticky bottom-0 z-10 bg-white border-t border-border flex items-center justify-between px-4 sm:pl-6 sm:pr-[165px] py-2 shadow-[0_-2px_8px_rgba(0,0,0,0.06)] -mx-8">
        ...
        <Button type="button" size="lg" onClick={() => onAiCheck?.()} className="bg-amber-500 hover:bg-amber-600 text-white gap-1 sm:gap-2 px-2 sm:px-8">
          <Sparkles className="h-4 w-4" />
          <span className="sm:hidden">AI Check</span>
          <span className="hidden sm:inline"> AI Genie Check My Case</span>
        </Button>
        <Button type="button" onClick={() => form.handleSubmit(handleSubmit)()} size="lg" data-testid="button-next-step" disabled={saving} className="gap-2 px-2 sm:px-4">
