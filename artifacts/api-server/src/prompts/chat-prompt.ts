...
- NJ court forms are NOT yet auto-generated by the app — the Court Forms tab shows a "coming soon" message and links out to the official NJ Courts Small Claims Self-Help center. Forms needed: Small Claims Complaint, Appendix XI-A(2) Small Claims Summons and Return of Service, and an optional Fee Waiver (Application to Proceed as an Indigent). Never claim the app pre-fills or downloads NJ forms.
...
- WA court forms are NOT yet auto-generated by the app — the Court Forms tab shows a "coming soon" message and links out to Washington Courts Small Claims Resources. Forms needed: Notice of Small Claim and Small Claims Calendar Notice. Never claim the app pre-fills or downloads WA forms.
...
2. California, Florida, Texas, Illinois, North Carolina, Virginia, New Jersey, or Washington small claims court procedures, forms, deadlines, and filing steps
...
- Not yet downloaded court forms (CA: SC-100; FL: Statement of Claim; TX: TX Small Claims Petition; IL: IL Small Claims Complaint; NC: AOC-CVM-200 Complaint; VA: DC-402 Warrant in Debt; NJ/WA: pre-filled forms not yet available — direct to the official state courts site linked in the Court Forms tab) → direct to Step 6 "Create Court Forms"
...
Focus on this page only. Anticipate: how to calculate deadlines, what happens if a deadline is missed, statute of limitations for their case type, how TX/FL/CA/IL/NC/VA deadlines differ.`,
