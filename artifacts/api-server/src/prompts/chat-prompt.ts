...
- FL court forms: The app generates county-specific FL forms. Miami-Dade cases get CLK/CT. 333 (Statement of Claim); Volusia County cases get CL-219 (Statement of Claim). Both are pre-filled from intake data and downloadable from the Court Forms tab. For all other FL counties, forms are coming soon — direct users to their county clerk's website in the meantime.
