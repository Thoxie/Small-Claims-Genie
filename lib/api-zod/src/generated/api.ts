...
export const GetCaseResponse = zod
  .object({
    ...
    venueReason: zod.string().nullish(),
    venueBasis: zod.string().nullish(),
    courthouseId: zod.string().nullish(),
    courthouseName: zod.string().nullish(),
    courthouseAddress: zod.string().nullish(),
    courthouseCity: zod.string().nullish(),
    courthouseZip: zod.string().nullish(),
    courthousePhone: zod.string().nullish(),
    courthouseWebsite: zod.string().nullish(),
    filingFee: zod.number().nullish(),
    isSuingPublicEntity: zod.boolean().nullish(),
    publicEntityClaimFiledDate: zod.string().nullish(),
    isAttyFeeDispute: zod.boolean().nullish(),
    filedMoreThan12Claims: zod.boolean().nullish(),
