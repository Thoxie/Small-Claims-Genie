...
router.post("/help", async (req, res): Promise<void> => {
  ...
  if (isSignedIn === false) {
    ...
    const stateName = jurisdictionState === "FL" ? "Florida" : jurisdictionState === "TX" ? "Texas" : jurisdictionState === "IL" ? "Illinois" : jurisdictionState === "NC" ? "North Carolina" : jurisdictionState;
