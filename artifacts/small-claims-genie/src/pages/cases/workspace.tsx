  ...
  return (
    ...
    >
      <div className={activeTab === "chat" ? "flex-1 flex flex-col min-h-0" : "container mx-auto px-4 pt-0 pb-6 max-w-6xl flex flex-col gap-3"}>
        ...
        {/* ── Tab content ── */}
        <div className={activeTab === "chat" ? "flex-1 flex flex-col min-h-0" : "border rounded-lg bg-white shadow-sm min-h-[600px]"}>
          {activeTab === "intake" && (
            <IntakeTab
              caseId={caseId}
              initialData={extCase}
          ...
          {activeTab === "chat" && (
            <div className="flex-1 flex flex-col min-h-0 rounded-lg border shadow-sm">
              {/* Chat body */}
